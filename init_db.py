...
# 2026 fiscal year — weeks run Monday–Sunday
# Q1 is 5-4-5; Q2/Q3/Q4 are 4-4-5 (53-week year)
SEED_PERIODS = [
    (1,  "January 2026",   "2025-12-29", "2026-02-01", 0, 1),  # 5 wks, locked
    (2,  "February 2026",  "2026-02-02", "2026-03-01", 0, 1),  # 4 wks, locked
    (3,  "March 2026",     "2026-03-02", "2026-04-05", 0, 1),  # 5 wks, locked
    (4,  "April 2026",     "2026-04-06", "2026-05-03", 1, 0),  # 4 wks — ACTIVE
    (5,  "May 2026",       "2026-05-04", "2026-05-31", 0, 0),
    (6,  "June 2026",      "2026-06-01", "2026-07-05", 0, 0),
    (7,  "July 2026",      "2026-07-06", "2026-08-02", 0, 0),
    (8,  "August 2026",    "2026-08-03", "2026-08-30", 0, 0),
    (9,  "September 2026", "2026-08-31", "2026-10-04", 0, 0),
    (10, "October 2026",   "2026-10-05", "2026-11-01", 0, 0),
    (11, "November 2026",  "2026-11-02", "2026-11-29", 0, 0),
    (12, "December 2026",  "2026-11-30", "2027-01-03", 0, 0),
]
...
SEED_RECONS = [
    # (period, acct_num, acct_name, assignee, qb_balance, expected, threshold, status)
    (4,"1010","Operating Checking",3,284750.22,284750.22,500.00,"reconciled"),
    (4,"1020","Payroll Checking",3,42100.00,42100.00,100.00,"reconciled"),
    (4,"1100","Accounts Receivable",3,198340.55,195000.00,5000.00,"needs_attention"),
    (4,"1200","Prepaid Expenses",4,31200.00,31200.00,250.00,"reconciled"),
    (4,"1500","Fixed Assets, Net",3,412800.00,412800.00,1000.00,"reconciled"),
    (4,"2000","Accounts Payable",4,87450.00,91200.00,2000.00,"needs_attention"),
    (4,"2100","Accrued Liabilities",1,44000.00,None,1000.00,"open"),
    (4,"2200","Deferred Revenue",2,225600.00,225600.00,500.00,"reconciled"),
    (4,"2300","Payroll Liabilities",2,18700.00,None,500.00,"open"),
    (4,"3000","Common Stock",1,1200000.00,1200000.00,None,"reconciled"),
]
...
def init():
    ...
    _add_col(conn, "periods", "is_locked", "INTEGER NOT NULL DEFAULT 0")
    _add_col(conn, "users", "username", "TEXT UNIQUE")
    _add_col(conn, "reconciliations", "variance_threshold", "REAL")
    conn.commit()
    ...
    cur.executemany(
        "INSERT OR IGNORE INTO periods (id,label,start_date,end_date,is_active,is_locked) VALUES (?,?,?,?,?,?)",
        SEED_PERIODS)
    ...
    if cur.fetchone()[0] == 0:
        cur.executemany(
            """INSERT INTO reconciliations
               (period_id,account_number,account_name,assignee_id,qb_balance,expected_balance,variance_threshold,status)
               VALUES (?,?,?,?,?,?,?,?)""",
            SEED_RECONS)
